...
DECLARE
    ...
    v_estatus_inicial VARCHAR; -- Lo dejamos como VARCHAR temporalmente
BEGIN
    -- LÓGICA DE CRÉDITO:
    -- Buscamos si el método es PUE (Contado) o PPD (Crédito)
    ...
    -- 2. Insertar Factura (CON CASTER ::estatus_factura_enum)
    INSERT INTO factura (
        id_cliente, serie, folio, fecha_emision, 
        estatus, -- <--- Columna ENUM
        saldo_pendiente,
        ...
        v_estatus_inicial::estatus_factura_enum, -- <--- ¡AQUÍ ESTÁ LA MAGIA!
        v_saldo_inicial,
    ...
    -- 3. Insertar Detalles (Sin cambios)
